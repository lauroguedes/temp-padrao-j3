    ...
    Plugin.prototype = {
        ...
        defineElements: function() {
            ...
            if( _self.options.controllers.append !== false ){
                var resetButton = _self.options.controllers.showResetButton ? '<a href="#" class="rvfs-reset btn btn-mini hasTooltip" title="Fonte padrão">A</a>' : '';
                ...
                if( $.trim(template).length > 0 ){
                    ...
                    controllersHtml = '<div class="btn-group">' +
                                            '<a href="#" class="rvfs-decrease btn btn-mini hasTooltip" title="Diminuir fonte">A-</a></li>' +
                                            resetButton +
                                            '<a href="#" class="rvfs-increase btn btn-mini hasTooltip" title="Aumentar fonte">A+</a></li>' +
                                      '</div>';
                }
