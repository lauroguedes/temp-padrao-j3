...
<div class="contact-form rt-grid-4">
		...
		<fieldset>
			...
			<?php if ($this->params->get('show_email_copy')) { ?>
				<div class="control-group">
					...
					<div class="btn-form"><button class="btn btn-primary validate" type="submit"><?php echo JText::_('COM_CONTACT_CONTACT_SEND'); ?></button></div>
				</div>
			<?php } ?>
