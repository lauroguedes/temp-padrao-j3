...
<?php if($this->params->get('show_categories_notice')): ?>
    <div class="center alert alert-info">
      <small>
        ...
        <?php echo JText::sprintf('COM_JOOMGALLERY_USERCATEGORIES_NEW_CATEGORY_YOURCOUNT', count($this->items)); ?><br />
        <?php echo JText::sprintf('COM_JOOMGALLERY_USERCATEGORIES_NEW_CATEGORY_REMAINDER', ($this->_config->get('jg_maxusercat') - count($this->items))); ?><br />
      </small>
    </div>
<?php endif; ?>
